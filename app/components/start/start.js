...
function _renderCallback () { // DO NOT USE ARROW FUNCTION
  ...
  var templateData = this.$data; // or app.start.$data

  console.log('Component start has been rendered with Data:', templateData);
...
/* export local variables or functions as properties accessible through component:start as app.start.actionX(); */
var props = {
